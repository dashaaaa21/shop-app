...
const allProducts = [
  ...
  { id: 'w4', name: 'Cashmere Turtleneck Dress', price: 349, discountPrice: 279, images: ['https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800&h=1000&fit=crop&q=85'], category: 'Dresses', gender: 'women', isNewArrival: false, isFeatured: true, description: 'The dress that replaces everything else. Knitted in a fine-gauge cashmere with a flattering long silhouette, this turtleneck dress is cut slightly fitted through the body and flows to a midi length. Wear with knee-high boots for an effortlessly polished look.', stock: 7, rating: 4.9, specifications: { Material: '100% Grade-A Cashmere', Gauge: 'Fine (12 GG)', Length: 'Midi', Care: 'Dry clean only', Neckline: 'Roll neck' } },

  // MEN PRODUCTS (m1-m42)  
  { id: 'm1', name: 'Tailored Wool Suit', price: 599, discountPrice: 499, images: ['https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=600&h=600&fit=crop&q=80', 'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=600&h=600&fit=crop&q=80'], category: 'Suits', gender: 'men', isNewArrival: false, isFeatured: true, description: 'A masterpiece of modern tailoring. This two-piece suit is crafted from a Super 120s wool, offering an exceptionally smooth hand feel and natural drape. The slim-fit silhouette is cut to flatter without restricting movement — ideal for both boardroom and formal occasions.', stock: 8, rating: 4.9, specifications: { Material: '100% Super 120s Wool', Lining: '100% Viscose', Fit: 'Slim fit', Care: 'Dry clean only', Origin: 'Made in Italy' } },
  { id: 'm2', name: 'Premium Oxford Shirt', price: 129, images: ['https://images.unsplash.com/photo-1621072156002-e2fccdc0b176?w=600&h=600&fit=crop&q=80', 'https://images.unsplash.com/photo-1607345366928-199ea26cfe3e?w=600&h=600&fit=crop&q=80'], category: 'Shirts', gender: 'men', isNewArrival: false, isFeatured: true, description: 'The cornerstone of any well-dressed gentleman\'s wardrobe. Woven from a two-ply Oxford cotton, this shirt offers a subtle texture and exceptional durability. The classic fit allows for comfortable layering under a blazer or wearing alone.', stock: 22, rating: 4.7, specifications: { Material: '100% Two-ply Oxford Cotton', Fit: 'Classic fit', Care: 'Machine wash 40°C', Collar: 'Button-down', Origin: 'Made in Portugal' } },
