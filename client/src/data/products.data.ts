...
export const womenProducts: WomenProduct[] = [
  ...
  // ── ADDITIONAL PRODUCTS ────────────────────────────────────────
  {
    ...
    price: 279,
    images: [
      'https://images.unsplash.com/photo-1612336307429-8a898d10e223?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Dresses',
    gender: 'women',
    isNewArrival: true,
    isFeatured: true,
    description:
      'A modern icon reborn in pure silk charmeuse. This bias-cut slip dress skims the body with effortless grace, featuring adjustable spaghetti straps and a subtle cowl front. Wear alone or layered over a fitted turtleneck for a fashion-forward contrast.',
    stock: 8,
    rating: 4.9,
    specifications: {
  ...
  },
  {
    ...
    discountPrice: 269,
    images: [
      'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&h=1000&fit=crop&q=85',
    ...
    isFeatured: true,
    description:
      'Power dressing elevated to an art form. This single-breasted blazer is cut from a premium Italian wool in a sharp, structured silhouette. Padded shoulders, welt pockets, and a nipped waist create a commanding presence whether worn to the office or out for the evening.',
    stock: 10,
    rating: 4.8,
    specifications: {
      Material: '95% Wool, 5% Elastane',
  ...
  },
  {
    ...
    price: 149,
    images: [
      'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'women',
    isNewArrival: true,
    isFeatured: false,
    description:
      'Fluid movement and timeless elegance in one piece. This pleated midi skirt is crafted from a lightweight satin-finish fabric that catches light beautifully. The elasticated waist ensures comfort, while the knife pleats create a graceful silhouette in motion.',
    stock: 16,
    rating: 4.6,
    specifications: {
  ...
  },
  {
    ...
    price: 429,
    images: [
      'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Outerwear',
    gender: 'women',
    ...
    isFeatured: true,
    description:
      'The definitive outerwear investment. This oversized trench is crafted from a water-resistant gabardine with a clean, modern cut that feels both classic and of-the-moment. Storm flap, belt detail and epaulettes nod to heritage while the relaxed proportions keep it firmly contemporary.',
    stock: 7,
    rating: 4.9,
    specifications: {
      ...
      Length: 'Below knee',
      Care: 'Dry clean only',
      Closure: 'Belt and double-breasted buttons',
    },
  },
  {
    id: 'w19',
    ...
    isFeatured: false,
    description:
      'The turtleneck as a minimalist statement. Knitted from an extra-fine merino in a slim-fit silhouette that layers beautifully under blazers and coats. The long ribbed neck can be folded down for a chic layered look.',
    stock: 22,
    rating: 4.7,
    specifications: {
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Dresses',
    gender: 'women',
    isNewArrival: true,
    isFeatured: false,
    description:
      'Easy, effortless dressing for warmer days. This shirt dress is crafted from a premium stone-washed linen that softens beautifully with every wash. A relaxed fit, long sleeves, and a belted waist make it as versatile as it is elegant — for brunch, city strolls or travel.',
    stock: 14,
    rating: 4.6,
    specifications: {
      Material: '100% Stone-washed Linen',
      Length: 'Midi',
      Fit: 'Relaxed with belt',
      Care: 'Machine wash 40°C',
  ...
  },
  {
    ...
    isFeatured: false,
    description:
      'A showstopping evening piece with understated confidence. Cut from a rich midnight-blue velvet, this blazer channels old-Hollywood glamour through a modern lens. Shawl lapels, a single-button closure, and a slim-cut silhouette make it the hero of any evening look.',
    stock: 6,
    rating: 4.8,
    specifications: {
      Material: '80% Viscose, 20% Polyester Velvet',
      Lining: '100% Silk',
      Fit: 'Slim',
      Care: 'Dry clean only',
      Closure: 'Single button',
  ...
  {
    id: 'w22',
    name: 'Tailored Wide-Leg Suit Trousers',
    price: 179,
    discountPrice: 149,
    images: [
      'https://images.unsplash.com/photo-1583744946564-b52ac1c389c8?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'women',
    isNewArrival: true,
    isFeatured: false,
    description:
      'The wide-leg trouser at its most refined. Cut from a premium stretch-wool in a high-waisted, wide-leg silhouette with front creases for a polished finish. Pair with the matching blazer for a full suit look or mix with fine knitwear for relaxed elegance.',
    stock: 18,
    rating: 4.7,
    specifications: {
      Material: '92% Wool, 8% Elastane',
      Rise: 'High',
      Leg: 'Wide',
      Care: 'Dry clean recommended',
      Closure: 'Concealed zip with hook',
    },
  },
  {
    id: 'w23',
    name: 'Draped Chiffon Blouse',
    price: 129,
    images: [
      'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=800&h=1000&fit=crop&q=85',
    ...
    isFeatured: false,
    description:
      'Movement and femininity in every thread. This draped chiffon blouse features a soft V-neckline, cascading front drape, and billowing long sleeves that feel as luxurious as they look. Crafted from a lightweight silk-chiffon blend that photographs beautifully.',
    stock: 20,
    rating: 4.5,
    specifications: {
      Material: '60% Silk, 40% Chiffon',
      Neckline: 'Draped V-neck',
      Fit: 'Loose',
      Care: 'Hand wash cold',
      Closure: 'Pull-over',
  ...
  },
  {
    ...
    price: 289,
    images: [
      'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Jackets',
    gender: 'women',
    ...
    isFeatured: false,
    description:
      'A nod to Parisian chic in a textured boucle. This collarless jacket is woven in a classic ivory and cream boucle tweed, featuring four-pocket styling, a slightly boxy silhouette, and delicate chain-weight hem. A piece that belongs to no era — and every one.',
    stock: 9,
    rating: 4.8,
    specifications: {
      Material: '55% Wool, 30% Acrylic, 15% Cotton Boucle',
      Lining: '100% Viscose',
      Fit: 'Boxy',
      Care: 'Dry clean only',
  ...
  },
  {
    ...
    price: 349,
    images: [
      'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Dresses',
    gender: 'women',
    ...
    isFeatured: true,
    description:
      'The dress that replaces everything else. Knitted in a fine-gauge cashmere with a flattering long silhouette, this turtleneck dress is cut slightly fitted through the body and flows to a midi length. Wear with knee-high boots for an effortlessly polished look.',
    stock: 7,
    rating: 4.9,
    specifications: {
      Material: '100% Grade-A Cashmere',
  ...
  },
  {
    ...
    price: 159,
    images: [
      'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'women',
    ...
    isFeatured: false,
    description:
      'Utility meets luxury. These straight-leg trousers are crafted from a satin-finish fabric with four functional cargo pockets styled with subtle finesse. The result is a piece that balances relaxed practicality with an elevated, fashion-forward sensibility.',
    stock: 15,
    rating: 4.5,
    specifications: {
      Material: '100% Polyester Satin',
  ...
  },
  {
    ...
    isFeatured: true,
    description:
      'The statement piece for when nothing else will do. This column silhouette gown is entirely hand-embroidered with micro-sequins in a deep champagne gold, creating a shimmering effect that transforms with every movement. Cut floor-length with a subtle side slit.',
    stock: 4,
    rating: 5.0,
    specifications: {
      Material: 'Sequin embroidery on silk base',
      Length: 'Floor-length',
      Silhouette: 'Column',
      Care: 'Dry clean only',
      Closure: 'Concealed back zip with modesty hook',
    },
  },
  {
    id: 'w28',
    ...
    discountPrice: 419,
    images: [
      'https://images.unsplash.com/photo-1544022613-e87ca75a784a?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Jackets',
    gender: 'women',
    ...
    isFeatured: false,
    description:
      'The cropped leather jacket that never goes out of style. Cut from a supple full-grain lambskin leather in a fitted, waist-length silhouette. Features a minimal zip front, clean lines, and a buttery soft hand feel that only improves with age.',
    stock: 6,
    rating: 4.8,
    specifications: {
  ...
  },
  {
    ...
    isFeatured: false,
    description:
      'Light as air, beautifully textured. This open-knit sweater is crafted from a premium cotton-linen blend in a loose, relaxed fit. The open stitch pattern creates a striking tactile effect while keeping the piece airy and breathable for warmer seasons.',
    stock: 19,
    rating: 4.6,
    specifications: {
      Material: '60% Cotton, 40% Linen',
  ...
  },
  {
    ...
    isFeatured: false,
    description:
      'Wrap yourself in effortless style. This midi-length wrap skirt is cut from a flowing viscose crepe that drapes softly around the body. The adjustable tie waist makes it universally flattering, while the subtle A-line shape creates beautiful movement with every step.',
    stock: 23,
    rating: 4.5,
    specifications: {
...
export const menProducts: MenProduct[] = [
  ...
  // ── ADDITIONAL PRODUCTS ────────────────────────────────────────
  {
    ...
    discountPrice: 579,
    images: [
      'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Suits',
    gender: 'men',
    isNewArrival: true,
    isFeatured: true,
    description:
      'Black-tie dressing redefined. This slim-fit tuxedo is cut from a premium wool-mohair blend that delivers a subtle sheen under evening light. Satin peak lapels, a single-button front, and matching dress trousers with a satin side stripe complete a look of effortless formal authority.',
    stock: 5,
    rating: 4.9,
    specifications: {
  ...
  },
  {
    ...
    price: 149,
    images: [
      'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Shirts',
    gender: 'men',
    isNewArrival: true,
    isFeatured: true,
    description:
      'The overshirt elevated. Woven from a soft brushed flannel in a classic windowpane check, this piece layers perfectly over a fine knit or t-shirt. Chest patch pockets, a relaxed body, and button cuffs make it equally at home in town or countryside.',
    stock: 18,
    rating: 4.7,
    specifications: {
      Material: '100% Brushed Cotton Flannel',
      Pattern: 'Windowpane check',
      Fit: 'Relaxed',
      Care: 'Machine wash 40°C',
      Pockets: 'Two chest patch pockets',
    },
  },
  {
    id: 'm30',
    ...
    discountPrice: 449,
    images: [
      'https://images.unsplash.com/photo-1521223890158-f9f7c3d5d504?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1548126032-079a0fb0099d?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Jackets',
    gender: 'men',
    isNewArrival: true,
    isFeatured: true,
    description:
      'The definitive leather jacket, built to last a lifetime. Crafted from full-grain calf leather with an asymmetric zip, silver-tone hardware, and a slim-fit silhouette. The quilted shoulder panels and zippered cuffs nod to its heritage while keeping it firmly contemporary.',
    stock: 7,
    rating: 4.9,
    specifications: {
      Material: '100% Full-grain Calf Leather',
      Lining: '100% Viscose',
      Fit: 'Slim fit',
      Care: 'Professional leather clean only',
      Hardware: 'Silver-tone YKK zips',
    },
  },
  {
    id: 'm31',
    ...
    price: 129,
    images: [
      'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'men',
    isNewArrival: true,
    isFeatured: false,
    description:
      'Warm-weather tailoring at its most refined. Cut from a premium Irish linen in a relaxed fit with a mid-rise and wide leg, these trousers drape beautifully and breathe freely. An elastic waistband with a drawstring keeps comfort at the fore.',
    stock: 22,
    rating: 4.6,
    specifications: {
  ...
  {
    id: 'm32',
    name: 'Fine Gauge Mock-Neck Sweater',
    price: 175,
    images: [
      'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1578932750294-f5075e85f44a?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'SWEATERS',
    gender: 'men',
    isNewArrival: true,
    isFeatured: false,
    description:
      'Understated and refined. This fine-gauge mock-neck is knitted from a merino-silk blend, giving it a subtle lustre and exceptional softness. The slim silhouette and clean neck make it an ideal foundation layer beneath a blazer or worn on its own.',
    stock: 14,
    rating: 4.8,
    specifications: {
  ...
  },
  {
    ...
    isFeatured: false,
    description:
      'Lightweight warmth without the bulk. This quilted down gilet is filled with 90/10 duck down in a channel-stitch pattern, and finished with a matte nylon shell that resists wind and light rain. The perfect mid-layer for transitional weather.',
    stock: 16,
    rating: 4.7,
    specifications: {
      Material: 'Matte Nylon Shell, 90/10 Duck Down Fill',
      Fill: '600 fill power',
      Fit: 'Regular',
      Care: 'Machine wash 30°C, tumble dry low',
      Closure: 'Full-length zip with inner storm flap',
    },
  },
  {
    id: 'm34',
    ...
    price: 115,
    images: [
      'https://images.unsplash.com/photo-1607345366928-199ea26cfe3e?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1621072156002-e2fccdc0b176?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Shirts',
    gender: 'men',
    isNewArrival: true,
    isFeatured: false,
    description:
      'A contemporary take on the classic dress shirt. Woven from a fine Egyptian cotton poplin, this slim-fit shirt features a clean band collar, a concealed button placket, and a slightly tapered body. Looks as sharp open-neck as it does under a tie.',
    stock: 26,
    rating: 4.6,
    specifications: {
      Material: '100% Egyptian Cotton Poplin',
      Fit: 'Slim fit',
      Care: 'Machine wash 40°C, press lightly',
      Collar: 'Band (no collar)',
      Cuffs: 'Double-button',
    },
  },
  {
    id: 'm35',
    name: 'Heavyweight Knit Cardigan',
    price: 245,
    images: [
      'https://images.unsplash.com/photo-1611312449408-fcece27cdbb7?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1578932750294-f5075e85f44a?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Knitwear',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'Substantial warmth, exceptional character. This heavyweight cardigan is knitted from a chunky pure wool yarn in a classic moss-stitch pattern. The relaxed boxy fit, ribbed cuffs, and genuine wooden buttons give it a timeless artisanal quality.',
    stock: 11,
    rating: 4.8,
    specifications: {
      Material: '100% Pure Wool',
  ...
  },
  {
    ...
    discountPrice: 109,
    images: [
      'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'Where tailoring meets athleisure. Cut from a premium ponte fabric with a clean front crease, these tapered joggers look dressed up but feel like your most comfortable pair. Elasticated waist and cuffs keep proportions sharp without sacrificing ease.',
    stock: 19,
    rating: 4.6,
    specifications: {
      ...
      Leg: 'Tapered',
      Care: 'Machine wash 30°C',
      Waist: 'Elasticated with internal drawstring',
    },
  },
  {
    id: 'm37',
    ...
    price: 159,
    images: [
      'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=800&h=1000&fit=crop&q=85',
    ],
    ...
    isFeatured: false,
    description:
      'A finishing touch of pure luxury. Woven from a 2-ply Grade-A cashmere in Scotland, this generously proportioned scarf offers unmatched softness and warmth. Available in a carefully curated palette of classic and contemporary tones.',
    stock: 30,
    rating: 4.9,
    specifications: {
      Material: '100% Grade-A Cashmere (2-ply)',
      Dimensions: '200 × 50 cm',
      Finish: 'Hand-rolled fringe',
  ...
  },
  {
    ...
    price: 179,
    images: [
      'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1548126032-079a0fb0099d?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Jackets',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'An autumn wardrobe hero. This mid-weight corduroy overshirt jacket is crafted from a fine-wale cotton cord in a relaxed, shirt-jacket silhouette. Four patch pockets, a classic collar, and button-front closure make it infinitely versatile.',
    stock: 13,
    rating: 4.7,
    specifications: {
  ...
  },
  {
    ...
    discountPrice: 109,
    images: [
      'https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Shirts',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'Smart-casual perfection. Knitted from an extra-fine merino wool in a classic piqué-inspired texture, this polo shirt bridges the gap between knitwear and shirting. The two-button placket, ribbed collar, and clean fit make it ideal for any occasion above casual.',
    stock: 24,
    rating: 4.7,
    specifications: {
      Material: '100% Extra-fine Merino Wool',
      Texture: 'Fine piqué',
      Fit: 'Regular',
      Care: 'Hand wash cold or machine wash 30°C',
  ...
  },
  {
    ...
    price: 289,
    images: [
      'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Suits',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'Effortless summer tailoring. This unstructured blazer is cut from a premium Belgian linen with a soft, floating canvas construction — no padding, no stiffness, just clean, relaxed elegance. Pairs as naturally with tailored shorts as with chinos or trousers.',
    stock: 9,
    rating: 4.8,
    specifications: {
      Material: '100% Belgian Linen',
      Construction: 'Unstructured, floating canvas',
      Fit: 'Relaxed',
      Care: 'Machine wash 30°C or dry clean',
      Pockets: 'Chest welt, two patch hip',
    },
  },
  {
    id: 'm41',
    ...
    price: 79,
    images: [
      'https://images.unsplash.com/photo-1508345228704-935cc84bf5e2?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'Accessories',
    gender: 'men',
    isNewArrival: true,
    isFeatured: false,
    description:
      'The perfect cold-weather companion. Knitted from a fine lambswool in a classic ribbed pattern, this beanie is warm, soft, and lightweight enough to fold into a jacket pocket. Minimal branding, maximum versatility.',
    stock: 35,
    rating: 4.8,
    specifications: {
  ...
  {
    id: 'm42',
    name: 'Stretch Swim Shorts',
    price: 89,
    discountPrice: 69,
    images: [
      'https://images.unsplash.com/photo-1520975911925-0b12f6f0c059?w=800&h=1000&fit=crop&q=85',
      'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&h=1000&fit=crop&q=85',
    ],
    category: 'TROUSERS',
    gender: 'men',
    ...
    isFeatured: false,
    description:
      'Performance and style in equal measure. These mid-length swim shorts are cut from a quick-dry recycled nylon with four-way stretch. A clean tonal print, internal mesh lining, and a secure zip pocket make them as suitable for the pool deck as the beach.',
    stock: 28,
    rating: 4.6,
    specifications: {
      Material: '100% Recycled Nylon (quick-dry)',
      Length: 'Mid (above knee)',
      Lining: 'Internal mesh',
      Care: 'Machine wash 30°C, do not tumble dry',
      Pocket: 'One secure zip pocket',
    },
  },
];
